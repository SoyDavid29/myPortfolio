...
const HelloBtn: React.FC = () => {
  ...
  return (
    <motion.div
      ...
      className="bg-black text-white font-poppins font-semibold w-40 cursor-pointer overflow-hidden rounded-xl shadow-lg flex flex-col items-center justify-center m-auto absolute top-15.5 left-0 right-0 z-99"
